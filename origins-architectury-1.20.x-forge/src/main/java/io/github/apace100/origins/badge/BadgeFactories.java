...
public final class BadgeFactories {
	...
	public static final RegistryObject<BadgeFactory> SPRITE = register("sprite",
			new SerializableData()
					.add("sprite", SerializableDataTypes.IDENTIFIER),
			SpriteBadge::new);

	public static final RegistryObject<BadgeFactory> TOOLTIP = register("tooltip",
			new SerializableData()
					.add("sprite", SerializableDataTypes.IDENTIFIER)
	...
	public static final RegistryObject<BadgeFactory> KEYBIND = register("keybind",
			new SerializableData()
					.add("sprite", SerializableDataTypes.IDENTIFIER)
